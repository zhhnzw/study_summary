...
- Init ![img](../../src/redis/replication_demo00.png)
- 一个Master两个Slave ![img](../../src/redis/replication_demo01.png)
- 日志查看
  - 主机日志 ![img](../../src/redis/replication_demo02.png)
  - 备机日志 ![img](../../src/redis/replication_demo03.png)
  - `info replication` ![img](../../src/redis/replication_demo04.png)
- 主从问题
